...
const ImageControl = ( props ) => {
	...
	return (
		<BaseControl label={ props.label } className="gutena-block-control__image">
			<MediaUploadCheck>
				<MediaUpload
					title={ props.label }
			...
			{ !! imageId && (
				<div className="gutena-block-control__image-actions components-button-group">
					{ image && (
						<MediaUploadCheck>
							<MediaUpload
								title={ props.label }
			...
			{ !! enableImageSizes && !! imageId && image && (
				<SelectControl
					...
					className="gutena-block-control__image-size"
					value={ imageSize }
