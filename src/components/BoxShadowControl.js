...
const BoxShadowControl = ( {
	label = __( 'Enable Box Shadow', 'gutena-testimonial' ),
	toggleLabel = __( 'On', 'gutena-testimonial' ),
	attrValue,
	...
	const boxShadowAttr = {
		offsetX: __( 'Offset X', 'gutena-testimonial' ),
		offsetY: __( 'Offset Y', 'gutena-testimonial' ),
		blurRadius: __( 'Blur radius', 'gutena-testimonial' ),
		spreadRadius: __( 'Spread radius', 'gutena-testimonial' ),
	};
	...
	const controls = (
		<>
			...
			{ ( onBoxShadow || attrValue.onBoxShadow ) &&
				<>
					<BaseControl label={ __( 'Shadow Color', 'gutena-testimonial' ) } className="gutena-box-shadow-color-control">
						<ColorPalette
							colors={ attrColors }
					...
					<Spacer marginTop={ 2 }>
						<ToggleControl
							label={ __( 'Inset', 'gutena-testimonial' ) }
