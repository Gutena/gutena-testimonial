...
const ColorControl = ( {
    label = __( 'Color', 'gutena-testimonial' ),
    attrValue = {},
    ...
    if ( false === colorPanelsSettings ) {
        ...
        if ( bgColor ) {
            ...
            colorSettings.push( {
                ...
                label: __("Background", "gutena-testimonial"),
                ...gradientSettings
            } );
        }
        ...
        if ( linkColor ) {
            colorSettings.push( {
                ...
                label: __("Link", "gutena-testimonial"),
            } );
        }
        ...
        if ( iconColor ) {
            colorSettings.push( {
                ...
                label: __("Icon", "gutena-testimonial"),
            } );
        }
    } else {
    ...
    const controls = (
        <ToolsPanel label="" className="gutena-testimonial-color-toolpanel" resetAll={ () => onChangeFunc( {} ) } panelId={ panelId } >
