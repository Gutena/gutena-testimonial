...
const DEFAULT_PROPS = {
    normal: __( 'Normal', 'gutena-testimonial' ),
    //hover: __( 'Hover', 'gutena-testimonial' )
}

const noop = () => {};

const BorderGroup = ( {
    panelLabel = __( 'Border', 'gutena-testimonial' ),
    attrValue = {},
    ...
    const controls = (
        <>
            ...
            <BorderBoxControl
                label={ __( "Border", "gutena-testimonial" ) }
            ...
            { borderRadius &&
                <Spacer marginTop={ 4 } marginBottom={ 0 }>
                    <BoxControl
                        label={ __( "Radius", "gutena-testimonial" ) }
